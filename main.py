...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print(Colorate.Horizontal(Colors.rainbow, '{01}: Increase Money           500'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{02}: Increase Coins           1500'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{03}: King Rank                2000'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{04}: Change ID                2000'))
            ...
            console.print(Colorate.Horizontal(Colors.rainbow, '{07}: Number Plates            500'))
            ...
            console.print(Colorate.Horizontal(Colors.rainbow, '{10}: Delete Friends           300'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{11}: Unlock Paid Cars         1500'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{12}: Unlock all Cars          1400'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{13}: Unlock all Cars Siren    2000'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{14}: Unlock w16 Engine        800'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{15}: Unlock All Horns         700'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{16}: Unlock Disable Damage    700'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{17}: Unlock Unlimited Fuel    1500'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{18}: Unlock House 3           2500'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{19}: Unlock Smoke             2000'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{20}: Change Race Wins         800'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{21}: Change Race Loses        800'))
            console.print(Colorate.Horizontal(Colors.rainbow, '{22}: Clone Account            4000'))
